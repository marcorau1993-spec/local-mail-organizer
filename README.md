...
[![License: PolyForm Noncommercial 1.0.0](https://img.shields.io/badge/license-PolyForm%20Noncommercial%201.0.0-2563EB)](LICENSE)

> [!WARNING]
> This project is **source-available, not open source**. The public license permits
> noncommercial use only. Selling the software or using it for a commercial purpose
> requires a [separate written commercial license](COMMERCIAL-LICENSE.md).
...
and distribution are permitted only under those terms. Commercial use, including
sale or inclusion in a paid product or service, requires a
[separate written license](COMMERCIAL-LICENSE.md).
